...
public class Spritesheet {
	...
	public String name;
	public int ID, spriteSizeX, spriteSizeY, width, height;
	
	public Spritesheet(String name, String path, int spriteSizeX, int spriteSizeY){
		this.name = name;
		...
		try {
            ...
            System.out.println("Texture inited");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
